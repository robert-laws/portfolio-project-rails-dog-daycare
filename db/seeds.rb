...
@activity_1 = Activity.create(name: "Fetch the Stick", description: "Sticks are thrown far and dogs run to retrieve them", best_for_type: "energetic", best_for_size: "large", energy_usage: "high")
